...
import newRoomImage from "../../assets/navbarMenus/newRoomImage.jpg";
import userImg from "../../assets/defaultUser.jpeg";
      ...
      <Nav className="ml-auto">
        ...
        <Dropdown nav isOpen={menuOpen} toggle={() => toggleMenu()} className="tutorial-dropdown mr-2 mr-sm-3">
          ...
          <DropdownMenu right className="navbar-dropdown notifications-dropdown" style={{ width: "340px" }}>
            <DropdownItem><img src={calendarIcon} alt="Calendar Icon"/><span>12 days till pay house's fee</span></DropdownItem>
            <DropdownItem>
              <div>
                ...
                <img src={newRoomImage} alt="Notification Icon" className={s.newRoomImage}/>
                <p className="body-2 muted">We have a new room for renting</p>
              </div>
            </DropdownItem>
